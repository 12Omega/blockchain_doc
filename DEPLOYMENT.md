...
Hey there! This guide covers deploying the Academic Document Blockchain Verification System using free services - because who doesn't love free stuff?
...
Required Accounts (All Free - Seriously!)
...
JWT Setting Things Up (generate a strong random string)
JWT_SECRET=your_super_secret_jwt_key_minimum_32_characters
JWT_EXPIRE=7d

File Upload Setting Things Up
MAX_FILE_SIZE=10485760
ALLOWED_FILE_TYPES=pdf,doc,docx,jpg,jpeg,png

Security Setting Things Up
BCRYPT_ROUNDS=12
RATE_LIMIT_WINDOW_MS=900000
RATE_LIMIT_MAX_REQUESTS=100

Logging Setting Things Up
LOG_LEVEL=info
```
...
```env
API Setting Things Up (will be your Railway/Render backend URL)
...
4. Update Setting Things Up Files
