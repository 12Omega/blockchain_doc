Deployment Setting Things Up Summary

This document summarizes all deployment Setting Things Ups created for the Academic Document Blockchain Verification System.
...
5. `docs/FREE_SERVICES_SETUP.md`
   ...
   - API key generation
   - Setting Things Up instructions
   - Cost summary
...
9. `railway.json` & `railway.toml`
   - Railway platform Setting Things Up
   - Build and deploy settings
   - Health check Setting Things Up

10. `vercel.json`
    - Vercel platform Setting Things Up
    - Build settings
...
- Deploys to Sepolia
- Verifies on Etherscan
- Updates Setting Things Up files
...
The deployment Setting Things Up provides:
