...
7. [Post-Deployment Setting Things Up](#post-deployment-Setting Things Up)
...
Hey there! This guide provides step-by-step instructions for deploying the Academic Document Blockchain Verification System to production or testing environments.
...
- `.github/workflows/` - CI/CD Setting Things Up
...
```env
API Setting Things Up
REACT_APP_API_URL=https://your-backend.railway.app

Blockchain Setting Things Up
...
Save the contract addresses! You'll need them for backend and frontend Setting Things Up.
...
4. Follow DNS Setting Things Up instructions
...
Post-Deployment Setting Things Up
...
1. Network Setting Things Up:
   - Verify chain ID matches
   - Check RPC URL is accessible
   - Ensure network is added to MetaMask

2. Frontend Setting Things Up:
   ```env
   REACT_APP_CHAIN_ID=11155111
